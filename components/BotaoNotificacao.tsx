...
export default function BotaoNotificacao() {
  ...
  async function ativar() {
    // IMPORTANTE: no iOS/Safari, requestPermission() só funciona se for
    // chamado IMEDIATAMENTE dentro do clique do usuário, sem nenhum
    // "await" antes. Por isso ele vem primeiro, antes de qualquer espera.
    try {
